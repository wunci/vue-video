...
export const getVideoLikeData = (id, likeData , userName , videoName , videoImg , star ) => fetch('http://vue.wclimb.site/vi/'+ id +'/like', {
            method: "POST",
            body: JSON.stringify({like:likeData ,userName:userName, videoName:videoName,videoImg: videoImg, star: star}),
            mode: "cors",
         }).then(function(response) {
            return  response.text()
         })
...
export const reportComment = (id, userName , date , comment , videoName , avator) => fetch('http://vue.wclimb.site/vi/'+ id +'/comment', {
            method: "POST",
            body: JSON.stringify({ userName:userName , date: date, content: comment , videoName:videoName , avator:avator}),
            mode: "cors" 
         }).then(function(response) {
            return  response.text()
         })